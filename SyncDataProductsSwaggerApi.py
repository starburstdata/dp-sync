...
class SyncDataProductsSwaggerClient:
    def __init__(self, sep_host: str,
        ...
        if galaxy_api_key is None:
            ...
            galaxy_configuration.api_key = {'accessToken': api_key_response.json()['access_token']}
        else:
            galaxy_configuration.api_key = {'accessToken': galaxy_api_key}
