...
class ClusterServiceApi(object):
    ...
    def create_cluster(self, body, **kwargs):  # noqa: E501
        ...
        :param CreateCluster body: (required)
        :return: Cluster
    ...
    def delete_cluster(self, cluster_id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str cluster_id: - A Trino cluster - This parameter can be looked up using `name` instead of its Id. Use `name=value` instead of an Id to lookup/search using the `value`. `value` must be encoded ([see RFC](https://www.rfc-editor.org/rfc/rfc3986#section-2.2) including `=`)  (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def delete_cluster_with_http_info(self, cluster_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/public/api/v1/cluster/{clusterId}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_cluster_with_http_info(self, cluster_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/public/api/v1/cluster/{clusterId}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def list_cluster(self, **kwargs):  # noqa: E501
        """list_cluster  # noqa: E501

        Return the clusters of your account  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.list_cluster_with_http_info(**kwargs)  # noqa: E501
            return data
    ...
    def list_cluster_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='PaginatedCluster',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def patch_update_cluster(self, body, cluster_id, **kwargs):  # noqa: E501
        """patch_update_cluster  # noqa: E501

        Update a cluster. Only the owner of the cluster can perform this operation  Only include fields you wish to update. Missing or unrecognized fields are ignored.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_update_cluster(body, cluster_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param UpdateClusterPatch body: (required)
        :param str cluster_id: - A Trino cluster - This parameter can be looked up using `name` instead of its Id. Use `name=value` instead of an Id to lookup/search using the `value`. `value` must be encoded ([see RFC](https://www.rfc-editor.org/rfc/rfc3986#section-2.2) including `=`)  (required)
        :return: Cluster
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.patch_update_cluster_with_http_info(body, cluster_id, **kwargs)  # noqa: E501
        else:
            (data) = self.patch_update_cluster_with_http_info(body, cluster_id, **kwargs)  # noqa: E501
            return data

    def patch_update_cluster_with_http_info(self, body, cluster_id, **kwargs):  # noqa: E501
        """patch_update_cluster  # noqa: E501

        Update a cluster. Only the owner of the cluster can perform this operation  Only include fields you wish to update. Missing or unrecognized fields are ignored.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_update_cluster_with_http_info(body, cluster_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method patch_update_cluster" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `patch_update_cluster`")  # noqa: E501
        # verify the required parameter 'cluster_id' is set
        if ('cluster_id' not in params or
                params['cluster_id'] is None):
            raise ValueError("Missing the required parameter `cluster_id` when calling `patch_update_cluster`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/public/api/v1/cluster/{clusterId}', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
