...
class UserServiceApi(object):
    ...
    def get_user(self, user_id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str user_id: - A user - This parameter can be looked up using `email` instead of its Id. Use `email=value` instead of an Id to lookup/search using the `value`. `value` must be encoded ([see RFC](https://www.rfc-editor.org/rfc/rfc3986#section-2.2) including `=`)  (required)
        :return: User
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def patch_update_user(self, body, user_id, **kwargs):  # noqa: E501
        """patch_update_user  # noqa: E501

        Grant and revoke user roles  Only include fields you wish to update. Missing or unrecognized fields are ignored.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_update_user(body, user_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param UpdateUserPatch body: (required)
        :param str user_id: - A user - This parameter can be looked up using `email` instead of its Id. Use `email=value` instead of an Id to lookup/search using the `value`. `value` must be encoded ([see RFC](https://www.rfc-editor.org/rfc/rfc3986#section-2.2) including `=`)  (required)
        :return: User
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.patch_update_user_with_http_info(body, user_id, **kwargs)  # noqa: E501
        else:
            (data) = self.patch_update_user_with_http_info(body, user_id, **kwargs)  # noqa: E501
            return data

    def patch_update_user_with_http_info(self, body, user_id, **kwargs):  # noqa: E501
        """patch_update_user  # noqa: E501

        Grant and revoke user roles  Only include fields you wish to update. Missing or unrecognized fields are ignored.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_update_user_with_http_info(body, user_id, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `patch_update_user`")  # noqa: E501
        # verify the required parameter 'user_id' is set
        if ('user_id' not in params or
                params['user_id'] is None):
        ...
        return self.api_client.call_api(
            '/public/api/v1/user/{userId}', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
